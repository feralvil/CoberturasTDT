<h1><?php echo __('Leer Datos de Catastro de los Centros TDT');?></h1>
<?php
$ncentros = count($centros);
?>
<h2><?php echo __('Datos de Catastro encontrados') . '(' . $ncentros . ' ' . __('Centros') . ')';?></h2>
<?php
if ($ncentros > 0){
?>
    <?php
    ...
    <table class="ink-table hover alternating">
        <tr>
            ...
            <th><?php echo __('Referencia Catastral');?></th>
        ...
        ?>
            <tr>
                ...
                <td><?php echo $centro['Centro']['refcast'];?></td>
                <td><?php echo $centro['Centro']['comcast'];?></td>
            </tr>
        <?php
        }
        ?>
