<h1><?php echo __('Leer Datos de Dependencia de los Centros TDT');?></h1>
<?php
$ncentros = count($centros);
?>
<h2><?php echo __('Datos de Dependencia encontrados') . ' (' . $ncentros . ' ' . __('Centros') . ')';?></h2>
<?php
if ($ncentros > 0){
?>
    <?php
    ...
    <table class="ink-table hover alternating">
        <tr>
            ...
            <th><?php echo __('Dependencia Mux. Nacional');?></th>
            <th><?php echo __('Dependencia Mux. Autonómico');?></th>
        </tr>
        <?php
