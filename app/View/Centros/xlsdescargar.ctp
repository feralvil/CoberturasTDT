...
$objPHPExcel->getActiveSheet()->setCellValue("H3", __('Longitud'));
$objPHPExcel->getActiveSheet()->setCellValue("I3", __('Latitud'));
$objPHPExcel->getActiveSheet()->setCellValue("J3", __('Referencia Catastral'));
$objPHPExcel->getActiveSheet()->setCellValue("K3", __('Provincia'));
$objPHPExcel->getActiveSheet()->setCellValue("L3", __('Prop. Suelo'));
$objPHPExcel->getActiveSheet()->setCellValue("M3", __('Prop. Caseta'));
$objPHPExcel->getActiveSheet()->setCellValue("N3", __('Prop. Torre'));
$objPHPExcel->getActiveSheet()->setCellValue("O3", __('Sum. Eléctrico'));
$objPHPExcel->getActiveSheet()->setCellValue("P3", __('Info'));
...
foreach ($centros as $centro) {
    ...
    $objPHPExcel->getActiveSheet()->setCellValue("H" . $fila, $centro['Centro']['longitud']);
    $objPHPExcel->getActiveSheet()->setCellValue("I" . $fila, $centro['Centro']['latitud']);
    $objPHPExcel->getActiveSheet()->setCellValue("J" . $fila, $centro['Centro']['catastro']);
    $objPHPExcel->getActiveSheet()->getCell("K$fila")->setValueExplicit($centro['Centro']['provincia'], PHPExcel_Cell_DataType::TYPE_STRING);
    $objPHPExcel->getActiveSheet()->setCellValue("L" . $fila, $centro['Centro']['suelo']);
    $objPHPExcel->getActiveSheet()->setCellValue("M" . $fila, $centro['Centro']['caseta']);
    $objPHPExcel->getActiveSheet()->setCellValue("N" . $fila, $centro['Centro']['torre']);
    $objPHPExcel->getActiveSheet()->setCellValue("O" . $fila, $centro['Centro']['electrico']);
    $objPHPExcel->getActiveSheet()->setCellValue("P" . $fila, $centro['Centro']['info']);
    if ($relleno){
